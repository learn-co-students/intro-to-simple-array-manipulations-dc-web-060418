...
#it uses the insert method to add the new element to the 4th index of the array
  ...
  #using_flatten
      #takes in an argument of an array that contains other arrays and uses
      #the flatten method to return an array of strings
    def using_flatten(array)
     array.flatten
    end

  #using_delete
    #takes in two arguments, an array and a string, and uses the delete methodto
  ...
  #using_delete_at
    #takes in two arguments, an array and an integer and deletes the
